...
def validation(csv,cust):
    #report = validate(csv)
    #inspector = Inspector()
    #inspector.__init__(self,checks=['structure', 'schema'],skip_checks=[],infer_schema=False,infer_fields=False,order_fields=False,error_limit=10000,table_limit=config.DEFAULT_TABLE_LIMIT,row_limit=100000)
